...
export default function SystemMonitoring() {
  ...
  const tabs = [
    { name: "System Metrics", icon: <FiActivity className="text-lg" /> },
    { name: "System Logs", icon: <LuFileSpreadsheet className="text-lg" /> },
  ];
    ...
    <div className="w-full min-h-screen bg-gray-50">
      ...
      <div className="hidden lg:block p-5">
        ...
        <p className="text-gray-600 mt-1 mb-6">
          Monitor system health, performance metrics, and review detailed system logs.
        </p>
